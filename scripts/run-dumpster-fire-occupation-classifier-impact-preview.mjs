...
const outDir = "/private/tmp/scans-occupation-classifier-impact-build";
const compileArgs = [
  "tsc",
  "--target",
  "ES2022",
...
run("npx", compileArgs);
run("node", [path.join(outDir, "scripts/preview-dumpster-fire-occupation-classifier-impact.js"), ...process.argv.slice(2)], {
  env: {
    ...process.env,
