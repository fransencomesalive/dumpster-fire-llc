...
const outDir = "/private/tmp/scans-source-hygiene-build";
const compileArgs = [
  "tsc",
  "--target",
  "ES2022",
  ...
  "--outDir",
  outDir,
  "scripts/cleanup-dumpster-fire-source-hygiene.ts",
  "app/scans/store.ts",
...
run("npx", compileArgs);
run("node", [path.join(outDir, "scripts/cleanup-dumpster-fire-source-hygiene.js"), ...process.argv.slice(2)], {
  env: {
    ...process.env,
