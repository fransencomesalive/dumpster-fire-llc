...
const outDir = "/private/tmp/scans-matching-diagnostic-build";
const compileArgs = [
  "tsc",
  "--target",
  "ES2022",
  ...
  "--outDir",
  outDir,
  "scripts/diagnose-dumpster-fire-matching.ts",
...
run("npx", compileArgs);
run("node", [path.join(outDir, "scripts/diagnose-dumpster-fire-matching.js")], {
  env: {
    ...process.env,
