...
const outDir = "/private/tmp/scans-broad-source-sample-build";
const compileArgs = [
  "tsc",
  "--target",
  "ES2022",
  ...
  "--outDir",
  outDir,
  "scripts/audit-dumpster-fire-broad-source-sample.ts",
...
run("npx", compileArgs);
run("node", [path.join(outDir, "scripts/audit-dumpster-fire-broad-source-sample.js")], {
  env: {
    ...process.env,
