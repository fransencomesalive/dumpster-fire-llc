...
const outDir = "/private/tmp/scans-review-feedback-summary-build";
const compileArgs = [
  "tsc",
  "--target",
  "ES2022",
  ...
  "--outDir",
  outDir,
  "scripts/summarize-dumpster-fire-review-feedback.ts",
  "app/scans/store.ts",
...
run("npx", compileArgs);
run("node", [path.join(outDir, "scripts/summarize-dumpster-fire-review-feedback.js"), ...process.argv.slice(2)], {
  env: {
    ...process.env,
