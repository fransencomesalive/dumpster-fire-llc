...
const outDir = path.join(tmpdir(), "public-profile-repository-test-build");
const compileArgs = [
  "tsc",
  "--target",
  "ES2022",
  ...
  "--outDir",
  outDir,
  "scripts/test-public-profile-repository.ts",
...
run("npx", compileArgs);
run("node", [path.join(outDir, "scripts/test-public-profile-repository.js")]);
