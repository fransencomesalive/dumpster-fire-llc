...
const outDir = "/private/tmp/scans-recall-benchmark-build";
const compileArgs = [
  "tsc",
  "--target",
  "ES2022",
  ...
  "--outDir",
  outDir,
  "scripts/audit-dumpster-fire-recall-benchmark.ts",
...
run("npx", compileArgs);
run("node", [path.join(outDir, "scripts/audit-dumpster-fire-recall-benchmark.js")], {
  env: {
    ...process.env,
