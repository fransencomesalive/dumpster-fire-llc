...
const outDir = "/private/tmp/scans-verdict-benchmark-build";
const compileArgs = [
  "tsc",
  "--target",
  "ES2022",
  ...
  "--outDir",
  outDir,
  "scripts/benchmark-dumpster-fire-verdicts.ts",
  "app/scans/store.ts",
...
run("npx", compileArgs);
run("node", [path.join(outDir, "scripts/benchmark-dumpster-fire-verdicts.js"), ...process.argv.slice(2)], {
  env: {
    ...process.env,
