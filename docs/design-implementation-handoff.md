...
4. **Grain ground app-wide** (home/dashboard/onboarding/scans). Surfaces sit opaque on top. **Cards/components must never set a body/page background** — the grain owns that layer; halftone is not used as the app ground.
